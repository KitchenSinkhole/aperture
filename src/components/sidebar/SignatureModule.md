...
- The filter bar also shows the selected system's total signature count (e.g. "12 signatures") beside the scan-state button — always the unfiltered system total, unaffected by the active group/scan filters.
